...
for i in range(152, 153):                   # the relevant deployments are with IDs 152-176
    ...
    new_dataframe.to_csv('../fishing_app/assets/csv_data/logger_' + str(raw_values.logger_id[0]) + '_deployment_' + str(raw_values.deployment_id[0]) + '.csv')
